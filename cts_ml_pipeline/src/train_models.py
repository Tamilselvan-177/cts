...
def parse_args() -> argparse.Namespace:
    ...
    default_data_dir = Path(__file__).resolve().parent.parent / "source_data"
    default_output_dir = Path(__file__).resolve().parent.parent / "outputs"
    parser.add_argument("--data-dir", type=Path, default=default_data_dir, help="Directory containing source CSV files.")
    parser.add_argument("--output-dir", type=Path, default=default_output_dir, help="Directory for models, predictions, reports, and metrics.")
